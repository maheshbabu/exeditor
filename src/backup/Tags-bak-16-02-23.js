...
(function () {
  ...
  const Tags = (tag) => {
    ...
    const setActiveDropdown = (tab) => {
      console.log("setActiveDropdown", tab);
    ...
    const setSuggestionDropdown = (tagData) => {
      ...
      Reflect.ownKeys(tagData).forEach((tData) => {
        if (tData.toLowerCase() === "categories") {
          ...
          tagData[tData].forEach((category, index) => {
          ...
          const categoryFilter = ["Functions", "Properties"];
          categoryFilter.forEach((category) => {
            console.log("--", tagData[category]);
            const categoryName = category.replace(/ /g, "").toLowerCase();
            const categoryData = tagData[category];
            const tab = document.querySelector(
              `.tags-dropdown_content-item.${categoryName}`
            );
            console.log("tab", tab, categoryName);

            const tagItem = document.createElement("div");
            tagItem.className = `tags-dropdown--item ${categoryName}`;
        ...
        //   // Add dynamic tab header
        //   const dropdownHeadTab = create("div", {
        //     className: `tags-dropdown_head--${tData.toLowerCase()} ${activeClass}`,
        //     textContent: tData
        //   });
        //   dropdownHead.appendChild(dropdownHeadTab);
        ...
        //   // Add dynamic tab types like: function, property, operator
        //   const dropdownContentTab = create("div", {
        //     className: `tags-dropdown_content-item ${tData.toLowerCase()} ${activeClass}`
        //   });
        //   dropdownContent.appendChild(dropdownContentTab);
        // }
        ...
        //   if (tData !== "Categories") {
        //     const tab = document.querySelector(
        //       `.tags-dropdown_content-item.${tData.toLowerCase()}`
        //     );
        //     const tagItem = document.createElement("div");
        //     tagItem.className = `tags-dropdown--item ${tData.toLowerCase()}`;
        //     const tagVal = item?.Name || item;
        //     tagItem.textContent = tagVal;
        //     tagItem.setAttribute("data-value", tagVal);
        //     const tagTooltip = item?.Tooltip || item;
    ...
    const resetDropdownTabs = () => {
      Reflect.ownKeys(data).forEach((tab, index) => {
        wrap
          .querySelector(`.tags-dropdown_head--${tab}`)
    ...
    const resetContentTabs = () => {
      Reflect.ownKeys(data).forEach((tab, index) => {
        wrap
          .querySelector(`.tags-dropdown_content-item.${tab}`)
          .classList.remove("active");
      });
    };
